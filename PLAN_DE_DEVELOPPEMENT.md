...
> **Note de rebrand (avril 2026)** : projet initialement nommé *AgentStack* dans le cahier des charges v1.0 (`AgentStack_Cahier_des_charges.docx`), renommé **Praxis** — nom de marque définitif. Contenu fonctionnel et technique inchangé.
...
- **S0.1.2** : Choix juridiction (France / Estonie / Delaware / Suisse) — *question ouverte CDC §10.4*.
...
| **Sprint 19** | Partenariat assurantiel ou DAO de couverture — *question ouverte CDC §10.4* |
