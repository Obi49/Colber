...
"""Shared fixtures for the colber-crewai test suite.
...
- CrewAI components (callbacks, memory, tools) accept the test client
  so the public surface can be exercised end-to-end without spinning
  up a Colber stack.
...
@pytest.fixture
def make_step_callback(colber_client: ColberClient) -> Callable[..., Any]:
    """Factory: build a :class:`ColberStepCallback` bound to the test client."""
...
@pytest.fixture
def make_task_callback(colber_client: ColberClient) -> Callable[..., Any]:
    """Factory: build a :class:`ColberTaskCallback` bound to the test client."""
...
def make_memory(colber_client: ColberClient) -> Callable[..., Any]:
    """Factory: build a :class:`ColberLongTermMemory` bound to the test client."""
    ...
    def _build(
        ...
        **kwargs: Any,
        ...
        return ColberLongTermMemory(
            client=colber_client, agent_did=agent_did, **kwargs
        )
