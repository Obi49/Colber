 ...
 *
 *     pnpm --filter @colber/memory add -D testcontainers @testcontainers/postgresql @testcontainers/qdrant
 *
 * The Ollama side stays out-of-process — point at the colber-stack docker
