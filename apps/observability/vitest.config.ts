  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/clickhouse/**', // ClickHouse adapter + bootstrap require a real CH
        'src/domain/alert-repository.ts', // drizzle adapter, exercised via testcontainers
        'src/domain/log-repository.ts', // pure types/interfaces
