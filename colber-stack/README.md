# Colber — Stack de test (option A)

Stack Docker Compose **isolée** pour la phase β du projet Colber.
...
# Arrêt avec destruction des volumes (⚠️ wipe complet Colber)
docker compose down -v
```

## Réseau

Tous les services partagent le réseau bridge `colber_net`.
Les microservices Colber qui seront déployés ensuite rejoindront ce réseau.

## Volumes

Volumes nommés `colber_*` (pg_data, redis_data, etc.).
